...
import { ExerciseSearchModal } from "@/src/components/training/ExerciseSearchModal";
import { WorkoutTemplateRepository } from "@/src/repositories/WorkoutTemplateRepository";
import { WorkoutTemplateService } from "@/src/services/WorkoutTemplateService";
...
export default function WorkoutTemplateScreen() {
  ...
  const [currentFolderId, setCurrentFolderId] = useState<number>(
    folderIdParam ? Number(folderIdParam) : 1, // Busca folder, se não achar, joga para o primeiro folder criado pelo usuário id = 1
  );
